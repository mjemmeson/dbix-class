...
See also: L<DBIx::Class::ResultClass>
...
Similiar to a join, except the data is cached for future use, instead
of used directly from the ResultSet.  This allows you to jump to
different relationships within a Result without worrying about generating
a ton of extra SELECT statements.
