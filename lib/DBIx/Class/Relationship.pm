...
All helper methods are called similar to the following template:
  ...
  __PACKAGE__->$method_name('relname', 'Foreign::Class', \%cond|\@cond|\&cond?, L<\%attrs?|DBIx::Class::ResultSet/ATTRIBUTES>);
...
=item Arguments: $accessor_name, $related_class, $our_fk_column|\%cond|\@cond|\$cond?, L<\%attrs?|DBIx::Class::ResultSet/ATTRIBUTES>
